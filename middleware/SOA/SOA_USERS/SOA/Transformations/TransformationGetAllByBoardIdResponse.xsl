   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="WSDL">
            ...
            <oracle-xsl-mapper:rootElement name="getAllUserByBoardIdResponse" namespace="http://ds.hive5.com/elements"/>
      ...
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.4.0(XSLT Build 190828.0353.3300) AT [WED JUN 19 12:58:41 CEST 2024].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <ns0:getAllUserByBoardIdResponse>
         <xsl:for-each select="/ns0:getAllUserByBoardIdResponse/ns0:user">
            <ns0:user>
               <ns0:id>
               ...
               <ns0:password>
                  <xsl:value-of select="ns0:password"/>
               </ns0:password>
               <ns0:role>
                  <ns0:id>
                     <xsl:value-of select="ns0:role/ns0:id"/>
                  </ns0:id>
                  <ns0:name>
                     <xsl:value-of select="ns0:role/ns0:name"/>
                  </ns0:name>
               </ns0:role>
               <ns0:boards>
                  <xsl:for-each select="ns0:boards/ns0:board">
                     <ns0:board>
                        <ns0:id>
                           <xsl:value-of select="ns0:id"/>
                        </ns0:id>
