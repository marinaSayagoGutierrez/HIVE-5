   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="WSDL">
            ...
            <oracle-xsl-mapper:rootElement name="createUserRequest" namespace="http://ds.hive5.com/elements"/>
      ...
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.4.0(XSLT Build 190828.0353.3300) AT [WED JUN 19 13:05:32 CEST 2024].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <ns0:createUserRequest>
         <ns0:firstName>
            <xsl:value-of select="/ns0:createUserRequest/ns0:firstName"/>
         </ns0:firstName>
         <ns0:lastName>
            <xsl:value-of select="/ns0:createUserRequest/ns0:lastName"/>
         </ns0:lastName>
         <ns0:email>
            <xsl:value-of select="/ns0:createUserRequest/ns0:email"/>
         </ns0:email>
         <ns0:password>
            <xsl:value-of select="/ns0:createUserRequest/ns0:password"/>
         </ns0:password>
         <ns0:roleId>
            <xsl:value-of select="/ns0:createUserRequest/ns0:roleId"/>
         </ns0:roleId>
         <ns0:boards>
            <xsl:for-each select="/ns0:createUserRequest/ns0:boards/ns0:boardId">
               <ns0:boardId>
                  <xsl:value-of select="."/>
               </ns0:boardId>
            </xsl:for-each>
