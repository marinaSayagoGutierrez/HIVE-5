   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="WSDL">
            ...
            <oracle-xsl-mapper:rootElement name="getAllCardResponse" namespace="http://ds.hive5.com/elements"/>
      ...
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.4.0(XSLT Build 190828.0353.3300) AT [TUE JUN 25 12:22:28 CEST 2024].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <ns0:getAllCardResponse>
         <xsl:for-each select="/ns0:getAllCardResponse/ns0:card">
            <ns0:card>
               <ns0:id>
               ...
               <ns0:user>
                  <ns0:id>
                     <xsl:value-of select="ns0:user/ns0:id"/>
                  </ns0:id>
                  <ns0:firstName>
                     <xsl:value-of select="ns0:user/ns0:firstName"/>
                  </ns0:firstName>
                  <ns0:lastName>
                     <xsl:value-of select="ns0:user/ns0:lastName"/>
                  </ns0:lastName>
                  <ns0:username>
                     <xsl:value-of select="ns0:user/ns0:username"/>
                  </ns0:username>
                  <ns0:email>
                     <xsl:value-of select="ns0:user/ns0:email"/>
                  </ns0:email>
                  <ns0:password>
                     <xsl:value-of select="ns0:user/ns0:password"/>
                  </ns0:password>
                  <ns0:role>
                     <ns0:id>
                        <xsl:value-of select="ns0:user/ns0:role/ns0:id"/>
                     </ns0:id>
                     <ns0:name>
                        <xsl:value-of select="ns0:user/ns0:role/ns0:name"/>
                     </ns0:name>
                  </ns0:role>
               </ns0:user>
               <ns0:board>
                  <ns0:id>
                     <xsl:value-of select="ns0:board/ns0:id"/>
                  </ns0:id>
                  <ns0:name>
                     <xsl:value-of select="ns0:board/ns0:name"/>
                  </ns0:name>
               </ns0:board>
               <ns0:status>
                  <ns0:id>
                     <xsl:value-of select="ns0:status/ns0:id"/>
                  </ns0:id>
                  <ns0:name>
                     <xsl:value-of select="ns0:status/ns0:name"/>
                  </ns0:name>
               </ns0:status>
            </ns0:card>
         </xsl:for-each>
