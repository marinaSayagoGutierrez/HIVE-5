 ...
 *         &lt;element name="user" type="{http://ds.hive5.com/elements}userType"/&gt;
 *         &lt;element name="board" type="{http://ds.hive5.com/elements}boardType"/&gt;
 *         &lt;element name="status" type="{http://ds.hive5.com/elements}statusType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
